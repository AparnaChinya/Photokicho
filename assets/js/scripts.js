...
$(document).ready(function() {
	...
	*/
	...
	/*
	    Google map
	*/
    var position = new google.maps.LatLng(13.0006193, 77.5755045);
	...
	var blore_center = new google.maps.LatLng(12.9715844,77.5945777);

	$('.map').gmap({
	    'center': blore_center, 'zoom': 11, 'disableDefaultUI': true, 'scrollwheel': true, 'callback': function () {
	        var self = this;
	        self.addMarker({'position': position, 'icon':marker_image});
	    }
	});

	var my_map = $(".map").gmap("get", "map");
